...
type Event struct {
	...
	Type        EventType `gorm:"not null;default:'personal';size:20" json:"type" validate:"required,oneof=personal meeting deadline schedule absence substitution"`
	...
	SubstitutionID *uint `gorm:"index" json:"substitution_id,omitempty" validate:"omitempty,min=1"`
...
type CreateEventRequest struct {
	...
	Type           EventType `json:"type" binding:"omitempty,oneof=personal meeting deadline schedule absence substitution" validate:"omitempty,oneof=personal meeting deadline schedule absence substitution"`
...
type UpdateEventRequest struct {
	...
	Location       *string    `json:"location,omitempty" binding:"omitempty,max=500" validate:"omitempty,max=500"`
	Type           *EventType `json:"type,omitempty" binding:"omitempty,oneof=personal meeting deadline schedule absence substitution" validate:"omitempty,oneof=personal meeting deadline schedule absence substitution"`
	Color          *string    `json:"color,omitempty" binding:"omitempty,len=7" validate:"omitempty,len=7"`
...
type EventResponse struct {
	...
	SubstitutionID   *uint                       `json:"substitution_id,omitempty"`
...
func (e *Event) ToResponse() *EventResponse {
	response := &EventResponse{
		...
		SubstitutionID:   e.SubstitutionID,
