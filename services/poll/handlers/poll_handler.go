...
func (h *PollHandler) GetPoll(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(statusCode, gin.H{
			"error":      "Не удалось получить опрос",
			"details":    err.Error(),
			"request_id": requestID,
		})
		return
...
func (h *PollHandler) VotePoll(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(statusCode, gin.H{
			"error":      "Не удалось проголосовать в опросе",
			"details":    err.Error(),
			"request_id": requestID,
		})
		return
...
func (h *PollHandler) GetPollResults(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(statusCode, gin.H{
			"error":      "Не удалось получить результаты опроса",
			"details":    err.Error(),
			"request_id": requestID,
		})
		return
...
func (h *PollHandler) GetPollVoters(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(statusCode, gin.H{
			"error":      "Не удалось получить голосующих опроса",
			"details":    err.Error(),
			"request_id": requestID,
		})
		return
...
func (h *PollHandler) GetPendingPolls(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusInternalServerError, gin.H{
			"error":      "Не удалось получить ожидающие опросы",
			"details":    err.Error(),
			"request_id": requestID,
		})
		return
